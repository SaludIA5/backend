...
INTEGER_COLS = [
    'presion_sistolica', 'presion_diastolica', 'presion_media', 'frecuencia_cardiaca', 
    'frecuencia_respiratoria', 'glasgow_score'
]

def upgrade():
    # 1. ADD: Agregar la nueva columna 'recomendacion_modelo'
    op.add_column('episodes', sa.Column('recomendacion_modelo', sa.String(50), nullable=True))
