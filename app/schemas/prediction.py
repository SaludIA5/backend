...
class PredictionRequest(BaseModel):
    ...
    # antecedentes_cardiaco: Optional[str] = None
    # antecedentes_diabetes: Optional[str] = None
    # antecedentes_hipertension: Optional[str] = None
    ...
    # fio2_ge_50: Optional[str] = None
    # ventilacion_mecanica: Optional[str] = None
    # cirugia_realizada: Optional[str] = None
    # cirugia_mismo_dia_ingreso: Optional[str] = None
    # hemodinamia: Optional[str] = None
    # hemodinamia_mismo_dia_ingreso: Optional[str] = None
    # endoscopia: Optional[str] = None
    # endoscopia_mismo_dia_ingreso: Optional[str] = None
    # dialisis: Optional[str] = None
    # trombolisis: Optional[str] = None
    # trombolisis_mismo_dia_ingreso: Optional[str] = None
    ...
    # troponinas_alteradas: Optional[str] = None
    # ecg_alterado: Optional[str] = None
    # rnm_protocolo_stroke: Optional[str] = None
    # dva: Optional[str] = None
